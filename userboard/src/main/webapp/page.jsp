...
<%
	...
	int pageCount = 5; //한번에 출력될 페이징 버튼 수
...
<div class="container">
	...
	<div>
		...
		<ul class="pagination justify-content-center" style="margin:20px 0">
				...
				%>
		    			<li class="page-item">
		    				<a class="page-link text-dark" href="<%=request.getContextPath()%>/home.jsp?currentPage=<%=currentPage-1 %>&localName=<%=localName%>">
		    					이전
		    				</a>
		    			</li>
		    	<%
		    	...
		    	%>
		        		<li class="page-item disabled">
		        			<a class="page-link" href="<%=request.getContextPath()%>/home.jsp?page=<%=i %>&localName=<%=localName%>">
		        				<%=i %>
		        			</a>
		        		</li>
		        <%
		        ...
		        %>
					<li class="page-item">
						<a href="<%=request.getContextPath()%>/home.jsp?page=<%=currentPage+1 %>&localName=<%=localName%>">
							다음
						</a>
					</li>
				<%
